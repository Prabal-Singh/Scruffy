...
from scruffy.eval.cases import build_goal, load_suite, resolve_cases
from scruffy.eval.models import EvalDefaults
...
def test_load_eval_suite() -> None:
    ...
    assert {case.id for case in suite.cases} >= {"v1_po_1042", "v2_po_1042", "v3_po_1042"}
...
def test_write_report_serializes_datetimes(tmp_path: Path) -> None:
    ...
    from scruffy.eval.models import EvalSummary
    from scruffy.eval.report import write_report, utc_now
    from scruffy.eval.models import EvalReport
